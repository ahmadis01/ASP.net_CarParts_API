...
interface EnhancedTableProps {
    numSelected: number;
    onRequestSort: (event: React.MouseEvent<unknown>, property: keyof PartItem) => void;
        ...
        <Box sx={{ width: '100%' }}>
            <Paper sx={{ width: '100%', mb: 2 }}>
                                ...
                                rows.map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell  >{cars?.filter(c => row.cars.includes(c.id)).join(',')}</TableCell>
                ...
                <div className="flex p-4 justify-center">
                    ...
                    <Pagination dir='ltr' defaultPage={1} onChange={handleChangePage} count={Math.ceil(totalCount / rowsPerPage)} />
                </div>
            </Paper>
